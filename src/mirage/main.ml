...
module Unikernel_hello__9 = Unikernel.Hello(Solo5_os.Time)
...
let solo5_os_time__8 = lazy (
  return ()
  )

let unikernel_hello__9 = lazy (
  let __solo5_os_time__8 = Lazy.force solo5_os_time__8 in
  __solo5_os_time__8 >>= fun _solo5_os_time__8 ->
  Unikernel_hello__9.start _solo5_os_time__8
  )
